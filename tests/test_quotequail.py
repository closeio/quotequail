...
class HTMLQuoteTestCase(unittest.TestCase):
    ...
    def test_no_quote(self):
        self.assertEqual(
            quote_html("""<p>One</p><p>Two</p><p>Three</p>"""),
            [
    ...
    def test_prefix_tag(self):
        self.assertEqual(
            quote_html("""A<br>Begin forwarded message:<o:p></o:p>B"""),
            [
    ...
    def test_prefix_tag_2(self):
        ...
        self.assertEqual(
            quote_html("""A<br>Begin forwarded message:<http://test>B"""),
            [
...
class InternalTestCase(unittest.TestCase):
    def test_parse_reply(self):
        ...
        self.assertEqual(
            data, {"date": "2009/5/12", "from": "John Doe <john@doe.example>"}
        )

        data = parse_reply("On 8 o'clock, John Doe wrote:")
        self.assertEqual(data, {"date": "8 o'clock", "from": "John Doe"})
